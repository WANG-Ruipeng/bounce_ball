...
namespace ClawbearGames
{
    public class LeaderboardViewController : BaseViewController
    {
        ...
        /// <summary>
        /// Creating the leaderboard items.
        /// </summary>
        /// <param name="listPlayerData"></param>
        /// <param name="maxItem"></param>
        /// <returns></returns>
        private IEnumerator CRCreatingLeaderboardItems(List<LeaderboardData> listPlayerData)
        {
            ...
            else
            {
                ...
                ServicesManager.Instance.LeaderboardManager.CheckConnectedToDreamloServices((isConnected) =>
                {
                    if (isConnected)
                    {
                        ...
                        {
                            StartCoroutine(CRCreatingLeaderboardItems(playerDatas));
                        });
                    }
                    else
                    {
