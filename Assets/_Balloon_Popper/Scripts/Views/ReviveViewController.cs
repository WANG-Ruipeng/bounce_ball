...
namespace ClawbearGames
{
    public class ReviveViewController : BaseViewController
    {
        ...
        /// <summary>
        /// Hanlding fill amount of revive slider. 
        /// </summary>
        /// <param name="delay"></param>
        /// <returns></returns>
        private IEnumerator CRHanldingReviveSlider(float delay)
        {
        ...
        /// <summary>
        /// Hanlding count down text. 
        /// </summary>
        /// <param name="delay"></param>
        /// <returns></returns>
        private IEnumerator CRHanldingCountDownText(float delay)
        {
            float waitTime = IngameManager.Instance.ReviveWaitTime;
        ...
        /// <summary>
        /// Scaling revive button.
        /// </summary>
        /// <returns></returns>
        private IEnumerator CRScalingReviveButton()
        {
        ...
        public override void OnShow()
        {
            ...
            StartCoroutine(CRScalingReviveButton());
            StartCoroutine(CRHanldingReviveSlider(0.75f));
            StartCoroutine(CRHanldingCountDownText(0.75f));
        }
